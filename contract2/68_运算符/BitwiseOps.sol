...
// x = 1110 = 8 + 4 + 2 + 0 = 14
 // y = 1011 = 8 + 0 + 2 + 1 = 11
 // x & y = 1010 = 8 + 0 * 2 + 0 = 10   //全1得1，全0得0，遇1得0
function and(uint256 x,uint256 y) external  pure  returns(uint) {
    return  x & y;
}
// x = 1100 = 8 + 4 + 0 + 0 = 12
// y = 1001 = 8 + 0 + 0 + 1 = 9
 // x | y = 1101 = 8 + 4 + 0 + 1 = 13  遇1得1
function or(uint256 x,uint256 y) external  pure  returns (uint256) {
    return x | y;
}
// x = 1100 = 8 + 4 + 0 + 0 = 12
// y = 0101 = 0 + 4 + 0 + 1 = 5
// x ^ y = 1001 = 8 + 0 + 0 + 1 = 9   / 不一样的取1，一样的取0
function xor(uint256 x, uint256 y) external  pure returns (uint256) {
    return  x^y;
}
// x = 00001100 = 0 + 0 + 0 + 0 + 8 + 4 + 0 + 0 = 12
//~x = 11110011 = 128 + 64 + 32 + 16 + 0 + 0 + 2 + 1 = 243  取反
